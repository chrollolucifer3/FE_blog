...
function* handleActions() {
  ...
  yield takeLatest(updateAvatarUserSuccess, function* () {
    yield call(getNotification, 'success', 'Update avatar user success');
    yield put(getMe());
  });

  yield takeLatest(updateAvatarUserFail, function* () {
    yield call(getNotification, 'error', 'Update avatar user fail');
  });
