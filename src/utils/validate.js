import {isValidEmail, isValidPassword, isValidPhone, isValidBio} from "./helper";
  ...
  switch (type) {
    ...
    case 'bio':
      if (data.bio.length === 0) {
        dataError.bio = 'Please complete this required field!';
        error = true;
      } else if (!isValidBio(data.bio)) {
        dataError.bio = 'Maximum number of characters allowed: 250';
        error = true;
      } else {
        dataError.bio = '';
      }
